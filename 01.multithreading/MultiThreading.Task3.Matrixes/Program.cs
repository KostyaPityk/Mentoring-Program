...
namespace MultiThreading.Task3.MatrixMultiplier
{
    class Program
    {
        ...
        private static void CreateAndProcessMatrices(byte sizeOfMatrix)
        {
            ...
            Matrix pFirstMatrix = new Matrix(100, 100, true);
            Matrix pSecondMatrix = new Matrix(100, 100, true);
            IMatrix parallelMatrix = new MatricesMultiplierParallel().Multiply(pFirstMatrix, pSecondMatrix);
