...
namespace Expressions.Task3.E3SQueryProvider.Test
{
    public class E3SAndOperatorSupportTests
    {
        ...
        {
            const string expected = "'statements':[{'query':'Workstation:(EPRUIZHW006)'},{'query':'Manager:(John*)'}]";
            var translator = new ExpressionToFtsRequestTranslator();
            Expression<Func<IQueryable<EmployeeEntity>, IQueryable<EmployeeEntity>>> expression
                = query => query.Where(e => e.Workstation == "EPRUIZHW006" && e.Manager.StartsWith("John")); //  && e.Manager.EndsWith("test")); 3 And 
            /*
